          ...
          <>
            {/* Theme Toggle Button */}
                <button
                        ...
                        >
                  {isDark ? (
                                    <span className="group-hover:rotate-45 transition-transform block">&#9728;</span>span>
                                  ) : (
                                    <span className="group-hover:-rotate-12 transition-transform block">&#9790;</span>span>
                        )}
                </button>button>
                ...
                <nav className="fixed top-0 w-full z-50 bg-cinza-claro/80 dark:bg-preto-azulado/80 backdrop-blur-md border-b border-azul-claro/50 dark:border-azul-escuro/30 transition-colors duration-500">
                        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                                  ...
                                  <div className="hidden md:flex items-center space-x-8 text-xs font-bold uppercase tracking-widest text-azul-escuro dark:text-azul-claro">
                                              <a href="#home" className="hover:text-cta-laranja transition-colors">{t.nav.home}</a>a>
                                              <a href="#about" className="hover:text-cta-laranja transition-colors">{t.nav.about}</a>a>
                                              <a href="#experience" className="hover:text-cta-laranja transition-colors">{t.nav.experience}</a>a>
