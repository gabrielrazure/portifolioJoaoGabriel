      ...
      <nav className="fixed top-0 w-full z-50 bg-cinza-claro/80 dark:bg-preto-azulado/80 backdrop-blur-md border-b border-azul-claro/50 dark:border-azul-escuro/50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <a 
            ...
            className="bg-cta-laranja text-preto-azulado px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest hove/**
             * @license
             * SPDX-License-Identifier: Apache-2.0
             */
        ...
        }</main>r:bg-azul-escuro hover:text-white transition-all flex items-center gap-2 shadow-lg"
          >
